...
import com.task12.book.comparators.BookAuthorComparator;
import com.task12.book.comparators.BookNameComparator;
import com.task12.book.comparators.BookPriceComparator;
...
public class Main {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        Comparator<Book> comparator2 = new BookNameComparator().thenComparing(new BookAuthorComparator());
        ...
        Comparator<Book> comparator4 = new BookAuthorComparator().thenComparing(new BookNameComparator());
